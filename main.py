...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher', type=bool, help='train teacher', default=True)
    ...
    parser.add_argument('--train_dataset', type=str, default="cifar10_input/cifar10-train-misc.txt")
    parser.add_argument('--test_dataset', type=str, default="cifar10_input/cifar10-test-misc.txt")
